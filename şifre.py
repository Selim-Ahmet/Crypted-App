...
def main_screen():
    ...
    screen.title("App")
    Label(text="Enter ur text to encrypt or decrypt",fg="black",font=("calbri",13)).place(x=10,y=10)
    ...
    Button(text="Decrypt",height="2",width=23,bg="#00bd56",fg="white",bd=0,command=decrypt).place(x=180,y=250)
